    ...
    <Wrapper>
      <Inner>
        ...
        <Typography variant='caption' color='text.main' sx={{ mb: '16px' }}>
          {t('This image will appear at the top of your collection page.')}<br />
          {t('Avoid including too much text in this banner image, as the dimensions change on different devices. 1400 x 400 recommended.')}
        </Typography>
        ...
        <Flex>
          <Typography variant='caption' sx={{ mb: '16px' }} color='text.main'>
            {t('Collect a fee when a user re-sells an item you originally created.')}<br />
            {t('This is deducted from the final sale price and paid monthly to a payout address of your choosing.')}
          </Typography>
          <Switch
            value={hasRoyalty}
